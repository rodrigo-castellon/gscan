...
def main(args):
    ...
    logging.info('parameters: min_area={:.3g}; max_area={:.3g}; min_circularity={:.3g}; BLOB_THRESHOLD_VAL={:.3g}; mean={}; avg={}'.format(min_area, max_area, min_circ, BLOB_THRESHOLD_VAL, mean, avg))
